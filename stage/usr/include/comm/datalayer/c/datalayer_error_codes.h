...
DL_PROVIDER_SUB_HANDLING = 0x80040003,     //! use default subscription handling of provider
...
DL_RT_MALLOC_FAILED = 0x80060009,          //! allocation of shared memory failed - datalayer-shm connected?
