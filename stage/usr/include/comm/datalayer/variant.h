...
typedef enum class VariantType {
  ...
  EMPTY,              //! empty data - explizit no data returned
}VariantType;
...
constexpr auto DATALAYER_TYPE_EMPTY = "empty";
...
inline VariantType getBaseTypeFromArrayType(VariantType arrayType)
{
  ...
  switch (arrayType)
  {
    ...
    case ::comm::datalayer::VariantType::ARRAY_OF_TIMESTAMP:
      ...
      break;
    case ::comm::datalayer::VariantType::EMPTY:
      result = VariantType::EMPTY;
      break;
    default:
...
public:
  ...
  const char* typeAsCharString() const
  {
    ...
    switch (m_type)
    {
      ...
      case VariantType::EMPTY:             result = DATALAYER_TYPE_EMPTY;       break;
      default:
        result = "";
        break;
    }
  ...
  VariantType getTypeByName(const std::string &type) const
  {
    ...
    if (type == DATALAYER_TYPE_EMPTY)       { return VariantType::EMPTY; }
