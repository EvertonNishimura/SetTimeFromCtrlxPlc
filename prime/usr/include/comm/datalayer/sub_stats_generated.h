...
struct SubscriptionStatistics FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool mutate_numberClients(uint32_t _numberClients) {
  ...
  bool mutate_numberSubscriptions(uint32_t _numberSubscriptions) {
  ...
  bool mutate_numberSubscribedNodes(uint32_t _numberSubscribedNodes) {
  ...
  bool mutate_numberRTSubscribedNodes(uint32_t _numberRTSubscribedNodes) {
    return SetField<uint32_t>(VT_NUMBERRTSUBSCRIBEDNODES, _numberRTSubscribedNodes, 0);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<uint32_t>(verifier, VT_NUMBERCLIENTS) &&
           VerifyField<uint32_t>(verifier, VT_NUMBERSUBSCRIPTIONS) &&
           VerifyField<uint32_t>(verifier, VT_NUMBERSUBSCRIBEDNODES) &&
           VerifyField<uint32_t>(verifier, VT_NUMBERRTSUBSCRIBEDNODES) &&
           verifier.EndTable();
  }
