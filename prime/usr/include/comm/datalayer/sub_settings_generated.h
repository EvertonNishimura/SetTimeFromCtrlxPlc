...
struct SubscriptionSettingsT : public flatbuffers::NativeTable {
  ...
  uint32_t maximumRTSubscribedNodes = 50;
};
...
struct SubscriptionSettings FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    ...
    VT_MAXIMUMRTSUBSCRIBEDNODES = 12
  };
  ...
  uint32_t maximumRTSubscribedNodes() const {
    return GetField<uint32_t>(VT_MAXIMUMRTSUBSCRIBEDNODES, 50);
  }
  bool mutate_maximumRTSubscribedNodes(uint32_t _maximumRTSubscribedNodes) {
    return SetField<uint32_t>(VT_MAXIMUMRTSUBSCRIBEDNODES, _maximumRTSubscribedNodes, 50);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyField<uint32_t>(verifier, VT_MAXIMUMRTSUBSCRIBEDNODES) &&
           verifier.EndTable();
  }
...
struct SubscriptionSettingsBuilder {
  ...
  void add_maximumRTSubscribedNodes(uint32_t maximumRTSubscribedNodes) {
    fbb_.AddElement<uint32_t>(SubscriptionSettings::VT_MAXIMUMRTSUBSCRIBEDNODES, maximumRTSubscribedNodes, 50);
  }
...
inline flatbuffers::Offset<SubscriptionSettings> CreateSubscriptionSettings(
  ...
  builder_.add_maximumRTSubscribedNodes(maximumRTSubscribedNodes);
...
inline void SubscriptionSettings::UnPackTo(SubscriptionSettingsT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  ...
  { auto _e = maximumRTSubscribedNodes(); _o->maximumRTSubscribedNodes = _e; }
}
...
inline flatbuffers::Offset<SubscriptionSettings> CreateSubscriptionSettings(flatbuffers::FlatBufferBuilder &_fbb, const SubscriptionSettingsT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  ...
  auto _maximumRTSubscribedNodes = _o->maximumRTSubscribedNodes;
